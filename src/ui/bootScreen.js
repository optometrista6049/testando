...
export function createBootScreen(onStart){
    ...
    boot.style.backgroundPosition = 'center';

    boot.style.backgroundRepeat = 'no-repeat';

    // =====================================================
    // DARK OVERLAY
    // =====================================================

    boot.style.boxShadow =

        'inset 0 0 0 2000px rgba(0,0,0,0.45)';
    ...
    button.innerText = 'ENTRAR AL JUEGO';
